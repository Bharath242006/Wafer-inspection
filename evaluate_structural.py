"""
evaluate_structural.py

Evaluates the structural localizer algorithm (localization/structural_localizer.py)
...
compares with baseline performance, and exports results to results/structural_validation.csv.
"""
...
from localization.structural_localizer import locate_reference_pattern
...
def evaluate_validation():
    ...
    out_csv = os.path.join(results_dir, "structural_validation.csv")
    ...
    print(f"Evaluating structural localizer on {len(records)} validation pairs...")
    ...
    for idx, item in enumerate(records, start=1):
        ...
        pred_x, pred_y, _, _, _, _, _ = locate_reference_pattern(ref_path, search_path)
    ...
    # Save to results/structural_validation.csv
    ...
    baseline_mean = 369.10
    baseline_acc5 = 0.0

    print("\n==================================================")
    print("  STRUCTURAL LOCALIZER EVALUATION REPORT")
    print("==================================================")
    ...
    print("\nBASELINE COMPARISON")
    print("-------------------")
    print(f"Baseline Mean Error:          {baseline_mean:.2f} px")
    print(f"Structural Localizer Mean:    {overall['mean']:.2f} px (Improvement: {baseline_mean - overall['mean']:+.2f} px)")
    print(f"Baseline Accuracy (<= 5 px):   {baseline_acc5:.2f}%")
    print(f"Structural Acc (<= 5 px):     {overall['acc_5']:.2f}%")
