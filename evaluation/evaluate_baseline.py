...
Normalized Cross Correlation Baseline Evaluator script.
"""
...
def main():
    print("=" * 80)
    print("        EVALUATING BASELINE NORMALIZED CROSS-CORRELATION")
    print("=" * 80)
    ...
    for idx, row in enumerate(rows, start=1):
        ...
        pred_x, pred_y, score = locate_reference_pattern(ref_img, search_img)
    ...
    out_csv = os.path.join("outputs", "metrics", "baseline_validation.csv")
