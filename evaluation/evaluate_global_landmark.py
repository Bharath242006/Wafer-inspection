"""
evaluation/evaluate_global_landmark.py

Global Landmark Localizer Evaluator script.
"""
...
def main():
    print("=" * 80)
    print("        EVALUATING GLOBAL LANDMARK LOCALIZER")
    print("=" * 80)
    ...
    for idx, row in enumerate(rows, start=1):
        ...
        pred_x, pred_y, rank, score, _ = locate_global_landmark(ref_img, search_img)
    ...
    out_csv = os.path.join("outputs", "metrics", "global_landmark_validation.csv")
