...
Hybrid Candidate Ranker Evaluator script.
"""
...
from localization.final_localizer_hybrid import locate_reference_pattern_hybrid
...
def main():
    print("=" * 80)
    print("        EVALUATING HYBRID CANDIDATE RANKER")
    print("=" * 80)
    ...
    for idx, row in enumerate(rows, start=1):
        ...
        pred_x, pred_y, score, status, _ = locate_reference_pattern_hybrid(ref_img, search_img)
    ...
    out_csv = os.path.join("outputs", "metrics", "hybrid_validation.csv")
