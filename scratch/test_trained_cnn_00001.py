...
def test_trained_cnn_00001():
    ...
    # 2. Calculate Trained CNN similarity scores
    ...
    print("=" * 135)
    print("           TRAINED SIAMESE CNN CANDIDATE RANKER DIAGNOSTIC TEST FOR 00001.PNG")
    print("=" * 135)
